...
public class Book implements Serializable {
    ...
    public String BookNew(Customer c,Luxury ly,Deluxe dx,SuperDeluxe sdx,Transportation tr[][][],Laundry lr[][][],int ily,int flag1,int idx,int flag2,int isdx,int flag3)

    {
        cust=c;
        Fare f=new Fare();
        int no,i;
        String x = "Rooms Available";
...
//                    BookSuperDeluxe(c,sdx,g,isdx,c.ld,c.d);
        ...
        if(c.type==3)
        {
            if(flag3==0)
            {
                x = "No Super Deluxe Rooms Available";
                return x;
